    ...
    return (
      <View className='page'>
        <View className='padding-lg'>
          <View className='text-line-zh text-lg text-bold-6'>宁波柏悦酒店 ｜ 3天2晚打卡东钱湖畔中国首家度假系柏悦，酒店控必入！含2餐，更有航海俱乐部体验活动</View>
          <View className='text-lg margin-top-lg'>度假精选套餐—柏悦客房</View>
        </View>
        ...
        <View className='solid-bottom padding-lg flex justify-between align-center'>
          ...
          <Text className='text-red'>¥{ price * count }</Text>
        </View>
